...
<h1 style="text-align: center;">Checkout Báo cáo Lab</h1>
<a style="font-size: 60px; margin-left: 50px;" href="{{url('/cart/addlabbc')}}"><span class="iconify" data-icon="noto-v1:back-arrow"></span></a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        Review Order <div class="pull-right"><small><a class="afix-1" href="{{asset('cart/addlabbc')}}">Báo cáo</a></small></div>
                    </div>
