  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a class="btn_customer_action js_order_item" href="{{asset('/baocaokho/ctk/'.$item->id)}}"><span style="font-size: 40px;" class="iconify" data-icon="tabler:report-analytics"></span></a>
      </td>
